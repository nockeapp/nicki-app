...
export default {
  ...
  com_ui_pay_per_call: 'Inteligência Artificial da Empresa Nocke Pague por chamada e não por mês',
  com_ui_new_footer: 'A inteligência Artificial da Empresa Nocke.',
  com_ui_enter: 'Entrar',
  ...
  com_nav_welcome_message: 'Seja Bem vindo Cliente Nocke?',
